...
- Resume upload and scoring (based on keyword matching)
- Google Calendar integration for scheduling interviews
- Telnyx voice API to conduct automated interview calls
- MongoDB-based candidate tracking
- Realtime status update and dashboard
